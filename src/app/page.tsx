      ...
      <div className="container mx-auto p-4 relative">
        <div className="bg-white border-2 border-emerald-500 rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col justify-center">
            ...
            <a href="/blog/posts" className={`outline outline-1 outline-offset-2 border-emerald-600 text-emerald-600 hover:text-white py-2 px-4 rounded hover:bg-emerald-600 md:w-auto ${styles.fit_content}`}>
              Read
            </a>
          </div>
